<template>
  <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="demo-ruleForm">
    <h2 style="text-align: center">假期返校表单</h2>
  ...
  <el-form-item label="出行时间" required>
    <el-col :span="11">
      <el-form-item prop="date1">
        <el-date-picker type="date" placeholder="选择日期" v-model="form.gate" style="width: 100%;"></el-date-picker>
      </el-form-item>
    </el-col>
    <el-col class="line" :span="2">-</el-col>
    <el-col :span="11">
      <el-form-item prop="date2">
        <el-time-picker placeholder="选择时间" v-model="form.gate" style="width: 100%;"></el-time-picker>
      </el-form-item>
    </el-col>
  </el-form-item>

    <el-form-item label="离校时间" required>
    <el-col :span="11">
      <el-form-item prop="date1">
        <el-date-picker type="date" placeholder="选择日期" v-model="form.wate" style="width: 100%;"></el-date-picker>
      </el-form-item>
    </el-col>
    <el-col class="line" :span="2">-</el-col>
    <el-col :span="11">
      <el-form-item prop="date2">
        <el-time-picker placeholder="选择时间" v-model="form.wate" style="width: 100%;"></el-time-picker>
      </el-form-item>
    </el-col>
  </el-form-item>
  ...
  <el-form-item label="出行方式" prop="travel">
    <el-input v-model="form.travel"></el-input>
        ...
        <el-form-item label="出发地" prop="temp">
    <el-input v-model="form.place"></el-input>
  </el-form-item>
        <el-form-item label="目的地" prop="temp">
    <el-input v-model="form.destination"></el-input>
  </el-form-item>
        <el-form-item label="车次" prop="temp">
    <el-input v-model="form.train"></el-input>
  </el-form-item>

  <el-form-item label="是否经过高风险区" prop="resource">
    <el-radio-group v-model="form.risk">
      <el-radio label="是" name="是"></el-radio>
      <el-radio label="否" name="否"></el-radio>
    </el-radio-group>
  </el-form-item>

  </el-form-item>
        <el-form-item label="家庭所在省份" prop="home">
...
<script>
  export default {
    ...
    methods: {
      ...
      //   }],
        method: "POST",
        url: "http://106.13.30.60:8089/school/save",
