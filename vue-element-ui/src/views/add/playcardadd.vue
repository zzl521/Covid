<template>
  <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="demo-ruleForm">
    <h2 style="text-align: center">日常打卡信息填写</h2>
  ...
  <el-form-item label="状态" prop="state">
    <el-select v-model="form.state" placeholder="填写个人所在状态">
      <el-option label="在校" value="在校"></el-option>
      <el-option label="居家" value="居家"></el-option>
         <el-option label="隔离" value="隔离14天"></el-option>
      <el-option label="住院" value="住院"></el-option>
      <el-option label="封城" value="封城"></el-option>
    </el-select>
  </el-form-item>
...
<script>
  export default {
    ...
    methods: {
      ...
      //   }],
        method: "POST",
        url: "http://106.13.30.60:8089/playcard/save",
