...
//搜素功能
      ...
      if(!this.stext){
              ...
              this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/outdoor/findAll/1/6"
        ...
        vm.cname=""
          ...
          this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/outdoor/search/"+this.searchKey+"/"+this.stext
      ...
      edit(id){
        ...
        this.$router.push("/editschoolout/index/"+id)
    ...
    handleSizeChange(val) {
      ...
      fetchData(e){
        ...
        //  vm.page.current = currentPage
         this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/outdoor/findAll/"+e+"/20"
  ...
  //打开弹窗，提示删除情况
      open(id) {
        ...
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          this.axios({
          method: "DELETE",
          url: "http://106.13.30.60:8089/outdoor/deleteById/"+id
    ...
    //导出zip操作
     handleDownload() {
      ...
      import('@/vendor/Export2Zip').then(zip => {
        const tHeader = ['序列','姓名','性别','学号','院系','体温','填写时间']
        const filterVal = ['id','name','sex','card','depart','temp','writetime']
