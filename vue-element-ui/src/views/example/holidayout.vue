...
//搜素功能
      ...
      if(!this.stext){
         ...
         this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/home/findAll/1/6"
        ...
        vm.cname=""
          ...
          this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/home/search/"+this.searchKey+"/"+this.stext
      ...
      edit(id){
        ...
        this.$router.push("/editholidayout/index/"+id)
      ...
      fetchData(e){
        ...
        //  vm.page.current = currentPage
         this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/home/findAll/"+e+"/20"
  ...
  //打开弹窗，提示删除情况
      open(id) {
        ...
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          this.axios({
          method: "DELETE",
          url: "http://106.13.30.60:8089/home/deleteById/"+id
