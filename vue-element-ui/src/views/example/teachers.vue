<template>
  ...
  <el-input placeholder="请输入内容" v-model="stext" class="input-with-select" style="width:40%"/>
    ...
    <el-table :data="list" border fit highlight-current-row style="width: 100%" >
      ...
      <el-table-column width="100px" align="center" label="姓名">
        ...
        <template slot-scope="scope">
          <span>{{ scope.row.depart }}</span>
                  ...
                  <el-table-column min-width="110px" align="center" label="职务">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="100px" align="center" label="所在状态">
        <template slot-scope="scope">
...
//搜素功能
      ...
      if(!this.stext){
              ...
              this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/teacher/findAll/1/6"
        ...
        vm.cname=""
          ...
          this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/teacher/search/"+this.searchKey+"/"+this.stext
      ...
      edit(id){
        ...
        this.$router.push("/teachersedit/index/"+id)
    ...
    handleSizeChange(val) {
      ...
      fetchData(e){
        ...
        //  vm.page.current = currentPage
         this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/teacher/findAll/"+e+"/20"
  ...
  //打开弹窗，提示删除情况
      open(id) {
        ...
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          this.axios({
          method: "DELETE",
          url: "http://106.13.30.60:8089/teacher/deleteById/"+id
    ...
    //导出zip操作
     handleDownload() {
      ...
      import('@/vendor/Export2Zip').then(zip => {
        const tHeader = ['序列','姓名','性别','院系','职务','体温','所在状态','是否在风险地区','填写时间']
        const filterVal = ['id','name','sex','depart','work','temp','state','risk','writetime']
