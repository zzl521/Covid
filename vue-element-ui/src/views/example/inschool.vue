<template>
  ...
  <el-input placeholder="请输入内容" v-model="stext" class="input-with-select" style="width:40%"/>
    <el-select v-model="cname" slot="prepend" placeholder="请选择" @change="getKey">
      ...
      <el-option label="院系" value="depart"></el-option>
          <el-option label="返校地点" value="place"></el-option>
    </el-select>
    ...
    <el-table :data="list" border fit highlight-current-row style="width: 100%" >
      ...
      <el-table-column width="100px" align="center" label="姓名">
        ...
        <template slot-scope="scope">
          ...
          <el-table-column min-width="100px" align="center" label="返校地点">
        <template slot-scope="scope">
...
//搜素功能
      ...
      if(!this.stext){
              ...
              this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/indoor/findAll/1/6"
        ...
        vm.cname=""
          ...
          this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/indoor/search/"+this.searchKey+"/"+this.stext
      ...
      edit(id){
        ...
        this.$router.push("/editschoolin/index/"+id)
    ...
    handleSizeChange(val) {
      ...
      fetchData(e){
        ...
        // this.axios({
        //   method: "GET",
        //   url: "http://106.13.30.60:8089/home/find"
        ...
        //  vm.page.current = currentPage
         this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/indoor/findAll/"+e+"/20"
  ...
  //打开弹窗，提示删除情况
      open(id) {
        ...
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          this.axios({
          method: "DELETE",
          url: "http://106.13.30.60:8089/indoor/deleteById/"+id
    ...
    //导出zip操作
     handleDownload() {
      ...
      import('@/vendor/Export2Zip').then(zip => {
        const tHeader = ['序列','姓名','性别','学号','院系','体温','体返校地点','填写时间']
        const filterVal = ['id','name','sex','card','depart','temp','place','writetime']
