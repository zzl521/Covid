  ...
  export default {
    ...
    methods: {
      ...
      cancel(){
        ...
        this.$router.push("/example/outschool");
      },
      ...
      //刷新数据
        fatchDataById(){
            ...
            this.axios({
          method: "GET",
          url: "http://106.13.30.60:8089/outdoor/findById/"+id
      ...
      //   }],
        method: "PUT",
        url: "http://106.13.30.60:8089/outdoor/update",
         ...
         data: JSON.stringify(vm.form),
          ...
          if(resp.data=="success"){
           ...
           console.log(resp)
           vm.$router.push("/example/outschool");
